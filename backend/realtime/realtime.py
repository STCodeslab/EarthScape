...
def stream_collection(collection_name):
    """
    SSE stream with JWT in querystring: /stream/datasets?token=...
    Users: see only their own datasets' document changes.
    Admins: see only document changes for the owner of the globally-latest dataset.
    """
